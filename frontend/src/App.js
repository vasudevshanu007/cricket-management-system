...
import InjuryTracker from "./pages/Admin/InjuryTracker";
...
import TournamentStandings from "./pages/user/TournamentStandings";
import ScoutManagement from "./pages/Admin/ScoutManagement";
import AttendanceManagement from "./pages/Admin/AttendanceManagement";
import VenueManagement from "./pages/Admin/VenueManagement";
import FitnessPlanManagement from "./pages/Admin/FitnessPlanManagement";
import MyFitnessPlan from "./pages/user/MyFitnessPlan";
...
// Advanced feature HOCs
const MatchManagementHOC = Layout(MatchManagement);
const TeamManagementHOC = Layout(TeamManagement);
const ContractManagementHOC = Layout(ContractManagement);
const InjuryTrackerHOC = Layout(InjuryTracker);
const AnnouncementManagementHOC = Layout(AnnouncementManagement);
const TournamentManagementHOC = Layout(TournamentManagement);
const AnnouncementsHOC = Layout(Announcements);
const MatchResultsHOC = Layout(MatchResults);
const TournamentStandingsHOC = Layout(TournamentStandings);
const ScoutManagementHOC = Layout(ScoutManagement);
const AttendanceManagementHOC = Layout(AttendanceManagement);
const VenueManagementHOC = Layout(VenueManagement);
const FitnessPlanManagementHOC = Layout(FitnessPlanManagement);
const MyFitnessPlanHOC = Layout(MyFitnessPlan);
    ...
    <>
      ...
      <ThemeProvider theme={theme}>
        ...
        <ProSidebarProvider> {/* Use ProSidebarProvider */}
          ...
          {/* Advanced Feature Routes — Admin */}
          <Route path="/admin/matches" element={<AdminRoute><MatchManagementHOC /></AdminRoute>} />
          <Route path="/admin/teams" element={<AdminRoute><TeamManagementHOC /></AdminRoute>} />
          <Route path="/admin/contracts" element={<AdminRoute><ContractManagementHOC /></AdminRoute>} />
          <Route path="/admin/injuries" element={<AdminRoute><InjuryTrackerHOC /></AdminRoute>} />
          <Route path="/admin/announcements" element={<AdminRoute><AnnouncementManagementHOC /></AdminRoute>} />
          <Route path="/admin/tournaments" element={<AdminRoute><TournamentManagementHOC /></AdminRoute>} />

          {/* Advanced Feature Routes — User */}
          <Route path="/announcements" element={<UserRoute><AnnouncementsHOC /></UserRoute>} />
          <Route path="/matches" element={<UserRoute><MatchResultsHOC /></UserRoute>} />
          <Route path="/tournaments" element={<UserRoute><TournamentStandingsHOC /></UserRoute>} />
          <Route path="/my-fitness" element={<UserRoute><MyFitnessPlanHOC /></UserRoute>} />

          {/* Advanced Feature Routes — Admin (batch 2) */}
          <Route path="/admin/scouts" element={<AdminRoute><ScoutManagementHOC /></AdminRoute>} />
          <Route path="/admin/attendance" element={<AdminRoute><AttendanceManagementHOC /></AdminRoute>} />
          <Route path="/admin/venues" element={<AdminRoute><VenueManagementHOC /></AdminRoute>} />
          <Route path="/admin/fitness" element={<AdminRoute><FitnessPlanManagementHOC /></AdminRoute>} />
            </Routes>
          </BrowserRouter>
        </ProSidebarProvider>
      </ThemeProvider>
