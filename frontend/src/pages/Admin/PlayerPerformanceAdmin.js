...
/*const deletePlayerPx = async (id) => {
    try {
      await axios.delete(`https://cricket-management-system-2.onrender.com/api/admin/performance/delete/${id}`);
  ...
  const DeletePlayerP = async (id) => {
    ...
    try {
      ...
      //pdf
      const downloadPdf = () => {
        fetch('https://cricket-management-system-2.onrender.com/generate-pdf')
